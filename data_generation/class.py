...
sqltimvol = "INSERT INTO TIMEVOLUNTEER (VolunteerID, Day, availableFrom, availableTo) VALUES ( %s , %s ,%s ,%s )"
sqllesson = "INSERT INTO LESSON(LessonDate,ClassID,VolunteerID)  VALUES ( %s , %s ,%s)"
sqltimst = "INSERT INTO TIMESTUDENT (StudentID,Day,availableFrom,availableTo ) VALUES ( %s , %s ,%s ,%s )"
...
for i in range(3000):
    ...
    try:
        ...
        db.commit()
        for j in range(20): # students in class
            ...
            for k in range(idx):
                ...
                level2 = levels[k]
                cursor.execute(sqlstlvl,(ssn+j,start2,end2,level2,grade,))
                db.commit()
